...
#define STRING_CONFIG_H_AUTHOR "(Tevo Black Widow)" // Who made the changes.
...
// Is bltouch present on the Tevo machine?
#define TEVO_BLTOUCH
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.21,  19.21 }
    #define DEFAULT_Ki_LIST {   1.32,   1.32 }
    #define DEFAULT_Kd_LIST {  70.02,  70.02 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 867 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, -30, -3 }
